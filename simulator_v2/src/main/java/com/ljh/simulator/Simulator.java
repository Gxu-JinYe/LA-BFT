...
public class Simulator {
    ...
    public static final int RN = 100;  						//replicas节点的数量(rn)
    ...
    public static final int BANDWIDTH = 30000000;			    //节点间网络的额定带宽(bytes)(超过后时延呈指数级上升)
    ...
    public static final int THR_AGG_DELAY = 10; // 平均30ms

    public static final int THR_SIG_DELAY = 1;  // 实际0.3

    public static final int THR_VER_DELAY = 6;  // 平均6ms

    public static final int RSA_SIG_DELAY = 1;  // 平均1ms
