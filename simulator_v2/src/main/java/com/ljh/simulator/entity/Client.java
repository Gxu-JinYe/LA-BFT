...
import com.ljh.simulator.vo.ReplyMsg;
import com.ljh.simulator.vo.RequestMsg;
...
public class Client {
    ...
    public void receiveReply(Message msg) {
        ...
        System.out.println("Client " + id + " receive REPLY message from " + msg.sndId + " at time:" + msg.rcvtime);
    ...
    public void sendRequest(long time) {
        ...
        // 获取leader的id，通过 视图号v mod 节点总数RN
        int priId = v % Simulator.RN;
        Message requestMsg = new RequestMsg("Message", time, id, id, priId, time);
        Simulator.sendMsg(requestMsg, sendTag, netDlys);
