...
//		System.out.println(id+"[水位]"+h+"-"+(h+L));
	...
	public void receiveRequest(Message msg) {
		...
		System.out.println(id + "receive REQUEST from " + msg.sndId + " at time:" + msg.rcvtime);
	...
	public void receivePreprepare(Message msg) {
		...
		System.out.println(id + "receive PREPREPARE from " + msg.sndId + " at time:" + msg.rcvtime);

		int msgv = prePrepareMsg.v;
		int msgn = prePrepareMsg.n;
		int i = prePrepareMsg.i;    // 节点id，需要检查是否是由leader发出
	...
	public void receivePrepare(Message msg) {
		...
		System.out.println(id + "receive PREPARE from " + msg.sndId + " at time:" + msg.rcvtime);
