...
public class Simulator {
    ...
    public static long max_employ_bandwidth = 0;

    public static final int RN = 55;  						//replicas节点的数量(rn)
...
//    public static final float THR_AGG_DELAY = 10.0f; // 平均30ms
//
//    public static final float THR_SIG_DELAY = 0.3f;  // 实际0.3
//
//    public static final float THR_VER_DELAY = 6.0f;  // 平均6ms
//
//    public static final float RSA_SIG_DELAY = 1.0f;  // 平均1ms
//
//    public static final float RSA_VER_DELAY = 0.12f;  // 实际0.12

    private static Random random = new Random();

    public static float getThrAggDelay(){
        return random.nextFloat() * (30 - 10) + 10;
    }

    public static float getThrSigDelay(){
        return 0.3f;
    }

    public static float getThrVerDelay(){
        return random.nextFloat() * (10 - 5) + 5;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("【The end】消息平均确认时间为:"+totalTime/totalStableMsg
                +"毫秒;消息吞吐量为:"+tps+"tps");
        System.out.println("最大占用带宽:" + max_employ_bandwidth + "B");
